        ...
        <section id="features" className="py-20 md:py-32 bg-gray-50">
            <div className="container mx-auto px-4 sm:px-6 md:px-12">
                <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16">
                    <h2 className="text-primary-teal font-bold tracking-wide uppercase text-4xl sm:text-4xl mb-3">Features</h2>
                    <h3 className="font-sora text-2xl sm:text-2xl md:text-2xl lg:text-2xl font-bold text-neutral-slate mb-4 md:mb-6 px-4">
