  ...
  return (
    <section ref={ref} className="py-16 md:py-24 relative overflow-hidden bg-white">
      ...
      <div className="absolute inset-0 z-0">
        ...
        >
          <source src="/metrics.mp4" type="video/mp4" />
        </video>
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-12 relative z-10">
        ...
        >
          ...
          <h2 className="font-['Montserrat'] text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-teal-500 mt-5 leading-tight">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 auto-rows-auto sm:auto-rows-[140px]">
          ...
          <motion.div
            ...
            className="rounded-3xl bg-white border border-teal-500 shadow-[0_4px_20px_rgba(32,201,151,0.12)] p-6 hover:shadow-[0_6px_24px_rgba(32,201,151,0.22)] transition duration-300"
          >
            <p className="text-teal-500 text-sm font-medium">India's Fastest Growing Finance App</p>
          ...
          >
            <motion.span className="font-['Montserrat'] text-5xl md:text-6xl font-bold text-white">
          ...
          >
            <span className="font-['Montserrat'] text-5xl md:text-6xl font-bold text-[#2E3A39]">
          ...
          >
            ...
            <span className="font-['Montserrat'] text-6xl md:text-7xl font-bold text-[#2E3A39] block mb-4">
          ...
          >
            <p className="font-['Montserrat'] text-xl md:text-2xl font-semibold text-[#2E3A39]">
          ...
          >
            ...
            <span className="font-['Montserrat'] text-5xl font-bold text-[#2E3A39]">
        ...
        <motion.div className="text-center mt-12" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }}>
          <p className="text-teal-600 text-lg">
            Join over <span className="text-teal-600 font-semibold">500,000+</span> Indians managing money smarter.
          </p>
        </motion.div>
      </div>
    </section>
