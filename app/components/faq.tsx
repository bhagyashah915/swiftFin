    ...
    const faqs = [
        {
            ...
            a: "FINCO is a comprehensive financial management platform designed to streamline your business finances. We provide real-time analytics, automated invoicing, expense tracking, and seamless integration with your existing tools."
        },
        {
        ...
        },
        {
            ...
            a: "Absolutely! FINCO is fully responsive and works seamlessly on all devices. We also offer native iOS and Android apps with offline capabilities."
        },
        {
            q: "What integrations does FINCO support?",
            a: "FINCO integrates with over 150+ popular tools including QuickBooks, Xero, Stripe, PayPal, Salesforce, Slack, and more."
        }
    ];
                ...
                <div className="space-y-6 mb-16">
                    {faqs.map((faq, index) => {
                        ...
                        return (
                            <div
                                key={index}
                                className={`rounded-3xl overflow-hidden transition-all duration-300 shadow-lg hover:shadow-xl ${isOpen ? 'bg-teal-700' : 'bg-white'
                                    }`}
                            >
                                <button
                                ...
                                >
                                    <span className={`text-2xl font-bold pr-8 ${isOpen ? 'text-white' : 'text-gray-900'
                                        }`}>
                                        {faq.q}
                                    </span>
                                ...
                                >
                                    <div className={`px-10 pb-8 leading-relaxed pt-4 text-lg ${isOpen ? 'text-white/90 border-t border-white/20' : 'text-gray-700 border-t border-gray-100'
                                        }`}>
                                        {faq.a}
                                    </div>
                                </div>
